...
The two tables above are showing the top 5 and bottom 5 departments in terms of percentage of employees who choose to live in the city. These are expanded relative to the previous analysis, although the outcome is the same. First responders, financial officials, and legal employees choose to live outside the city, while transportation offcials, elections officals, waste management, and the liquor licensing board choose to live within the city. More individuals were filtered into the police department data during data clean-up, so to see its percentage minimally changed is interesting. It certainly suggests that the trends observed for the police department are consistent. 

## Notes on differences between analyzing the data with Excel vs. Python
